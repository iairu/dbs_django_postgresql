...
DATABASES = {
    # 'default': { # predvolene hodnoty, my pouzijeme postgresql
...
AUTH_PASSWORD_VALIDATORS = [ # zatial vypnute
    # {
...
USE_I18N = False # vypol som, viac-jazycnost zatial netreba
